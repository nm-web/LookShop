...
var menuHeader = function menuHeader() {
  $('.menu-header__title').on('click', function (e) {
    e.stopPropagation();
    e.preventDefault();
...
var headerSliderHome = function headerSliderHome() {
  $('.header-slider').slick({
    dots: true,
...
var sliderProductsPage = function sliderProductsPage() {
...
var tabsSliderFirst = function tabsSliderFirst() {
  if ($(window).width() > 639) {
...
var tabsSliderPage = function tabsSliderPage() {
  $('.tabs-nav__item').on('click', function (e) {
    var dataTab = $(e.currentTarget).attr('data-tab-name');
...
var tabsSliderArrows = function tabsSliderArrows() {
  $('.products-arrows').on('click', function (e) {
...
var productPageTabs = function productPageTabs() {
  $('.tabs-description__item').on('click', function (e) {
    $('.tabs-description__content').removeClass('tabs-description__content_active');
    $(e.currentTarget).children('.tabs-description__content').toggleClass('tabs-description__content_active');
  });
};
...
var tabsSlider = function tabsSlider(nameSlider) {
  var slider = $('.' + nameSlider);

  if ($(window).width() > 639 && !slider.hasClass('slick-initialized')) {
    tabsSliderPage(); // $(slider).slick({
    //   slidesToShow: 4,
    //   slidesToScroll: 1,
    //   centerMode: true,
    //   centerPadding: '32px',
